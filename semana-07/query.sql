...
(1, 'Advanced Java Programming', NULL, 'Laura Gomez', 89.99, 40, 'Advanced'),
...
(1, 'C# Fundamentals', NULL, 'Sebastian Diaz', 40.00, 15, 'Beginner'),
...
(1, 'Algorithms and Data Structures', NULL, 'Natalia Rojas', 85.00, 35, 'Advanced'),
...
(2, 'Figma for Designers', NULL, 'Valentina Lopez', 58.00, 20, 'Beginner'),
...
(3, 'Facebook Ads Expert', NULL, 'Diego Suarez', 65.00, 18, 'Beginner'),
(3, 'SEO Positioning Course', 'Improve Google rankings', 'Maria Fernanda Gil', 72.00, 24, 'Intermediate'),
(3, 'TikTok Content Creation', NULL, 'Kevin Morales', 45.00, 12, 'Beginner'),
...
(4, 'Leadership and Team Building', NULL, 'Angela Fonseca', 77.00, 26, 'Intermediate'),
(5, 'Data Analysis with Python', 'Analyze datasets using pandas', 'Esteban Gutierrez', 98.00, 40, 'Intermediate'),
(5, 'Machine Learning Essentials', NULL, 'Cristina Navarro', 145.00, 60, 'Advanced'),
...
('Maria', 'Gonzalez', 'maria.gonzalez@gmail.com', NULL, '1995-09-22', 'Mexico'),
...
('Camila', 'Ruiz', 'camila.ruiz@gmail.com', NULL, '2001-12-01', 'Chile'),
...
('Tatiana', 'Mora', 'tatiana.mora@gmail.com', NULL, '1992-02-17', 'Peru'),
...
('Angela', 'Fonseca', 'angela.fonseca@gmail.com', NULL, '1998-12-30', 'Chile'),
...
('Diego', 'Suarez', 'diego.suarez@gmail.com', NULL, '1995-10-20', 'Mexico'),
...
-- Mostrar cursos donde description ES NULL
...
-- Mostrar todos los cursos usando COALESCE
